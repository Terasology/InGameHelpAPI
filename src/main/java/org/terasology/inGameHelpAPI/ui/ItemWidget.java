...
/**
 * Widget class for items that contains the behavior and what appears on the {@link
 * org.terasology.rendering.nui.Canvas}. Typically used in conjunction with {@link WidgetFlowRenderable} to be added
 * onto a document. Contains the name of the item's prefab as well as the entity reference to the item.
 */
public class ItemWidget extends ItemCell {
    ...
    /**
     * Gets this widget's {@link org.terasology.entitySystem.entity.EntityRef}. Creates a new entityref if this item is
     * null.
     *
